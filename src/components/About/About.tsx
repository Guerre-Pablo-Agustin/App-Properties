    ...
    return (
       <Transition className="grid gap-4 px-4 py-8 md:py-44 md:px-36 md:grid-cols-2">
            <div className="max-w-xl mb-7 flex flex-col items-center justify-center" id="about">
                ...
                <p className="mb-10 mt-8">Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur non dolorum eveniet necessitatibus magni ad ab eius quod? Aspernatur voluptatem rem animi labore odit libero, qui non.</p>
            </div>
